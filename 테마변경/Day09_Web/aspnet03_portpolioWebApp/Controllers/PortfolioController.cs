...
namespace aspnet03_portfolioWebApp.Controllers
{
    public class PortfolioController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Create(TempPortfolioMoel temp)
        {
        ...
        private string UploadImageFile(TempPortfolioMoel temp)
        {
            var resultFileName = "";
            ...
            if (temp.PortfolioImage != null)
            {
                ...
                resultFileName = Guid.NewGuid() + "_" + temp.PortfolioImage.FileName; // 중복된 이미지파일명제거
